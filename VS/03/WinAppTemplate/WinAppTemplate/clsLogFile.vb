...
'*************************************************************************
		...
		Dim logEvent As String = UCase(Application.ProductName) & " STARTED"
		...
		If noErrorFlag Then
			...
			FilePath = LogFolder & "\" & Application.ProductName
...
'*************************************************************************
		...
		Dim logEvent As String = UCase(Application.ProductName) & " FINISHED" & vbCrLf
		Dim noErrorFlag = True 'return value for the function, returns false if an error occurs
